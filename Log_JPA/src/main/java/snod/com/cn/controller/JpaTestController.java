...
import snod.com.cn.service.JpaTestService;
...
public class JpaTestController {
	...
	private final static Logger logger = LoggerFactory.getLogger(JpaTestController.class);
	@Autowired
...
//			jpaTestService.manytomanySave();
	...
	public ResultInfo query(String name,String email){
